...
/** set_star_emission computes the emission line face-on brightness of
 * elements over the secondary star assuming proportionality to intensity
 * of flux from primary.
...
void Lcurve::set_star_emission(double limb2, double hbyr,
